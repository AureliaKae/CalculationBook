...
import { DEEPSEEK_BASE_URL, QWEN_BASE_URL, recommendedModelsFor } from "../../../src/client.js";
...
// assertKnownEndpoint）一一对应——公网只放行两家，http 只放行本机调试。
const PROVIDER_PRESETS = [
  { id: "deepseek", label: "DeepSeek", baseUrl: DEEPSEEK_BASE_URL },
  { id: "qwen", label: "阿里千问（百炼）", baseUrl: QWEN_BASE_URL },
          ...
          {panel === "bake" && (
            <>
              <div className="bake-row">
                ...
                <span className="studio-note">留空=按墨行官方建议（DeepSeek 4 / 千问 3）</span>
                <input
